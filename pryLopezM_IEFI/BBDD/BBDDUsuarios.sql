...
VALUES
(1, 'admin', 'admin123', 'Admin', 'Principal', 35, '12345678', 'Calle 1', '1234567890', 'admin@empresa.com', CONVERT(date, '1989/01/01', 111), CONVERT(date, GETDATE()), 'Administrador'),
(2, 'jdoe', 'pass1234', 'John', 'Doe', 28, '23456789', 'Calle 2', '1234567891', 'jdoe@mail.com', CONVERT(date, '1997/05/15', 111), CONVERT(date, '2023/03/01', 111), 'Operador'),
(3, 'mgarcia', 'secure456', 'María', 'García', 31, '34567890', 'Avenida Siempreviva 742', '1234567892', 'mgarcia@mail.com', CONVERT(date, '1993/08/10', 111), CONVERT(date, GETDATE()), 'Administrador'),
(4, 'lmendez', 'clave789', 'Luis', 'Méndez', 40, '45678901', 'Pasaje Los Andes 55', '1234567893', 'lmendez@mail.com', CONVERT(date, '1985/03/20', 111), CONVERT(date, '2023/04/15', 111), 'Operador'),
(5, 'srodriguez', 'rodrig123', 'Sofía', 'Rodríguez', 25, '56789012', 'Ruta 3 KM 45', '1234567894', 'srodriguez@mail.com', CONVERT(date, '1999/12/02', 111), CONVERT(date, GETDATE()), 'Administrador'),
(6, 'cfernandez', 'contraseña1', 'Carlos', 'Fernández', 38, '67890123', 'Boulevard San Martín 1200', '1234567895', 'cfernandez@mail.com', CONVERT(date, '1986/07/07', 111), CONVERT(date, '2023/02/28', 111), 'Operador'),
(7, 'nlopez', 'lopez2024', 'Natalia', 'López', 29, '78901234', 'Callejón del Sol 9', '1234567896', 'nlopez@mail.com', CONVERT(date, '1995/02/14', 111), CONVERT(date, GETDATE()), 'Administrador'),
(8, 'rhernandez', 'passRicky8', 'Ricardo', 'Hernández', 33, '89012345', 'Diagonal Norte 400', '1234567897', 'rhernandez@mail.com', CONVERT(date, '1991/11/23', 111), CONVERT(date, '2023/01/10', 111), 'Operador'),
(9, 'emartinez', 'martiZ21', 'Elena', 'Martínez', 27, '90123456', 'Av. Libertad 110', '1234567898', 'emartinez@mail.com', CONVERT(date, '1997/06/30', 111), CONVERT(date, GETDATE()), 'Administrador'),
(10, 'jperez', 'jperez2025', 'Javier', 'Pérez', 36, '11223344', 'Calle Falsa 123', '1234567899', 'jperez@mail.com', CONVERT(date, '1988/10/05', 111), CONVERT(date, '2023/05/20', 111), 'Operador'),
